...
import { FormData } from 'form-data';
  ...
  const StudentUI = () => {
    ...
    async function submitHandler (){
        ...
        form.append('user_input', '"Create a course content on Data Science having subtopics "');
    ...
    return (
      <div className="App">
        <div className="course-input">
         <TextField label="Enter the course name :" variant="outlined" onChange={(e)=>textHandler(e)} />
         {/* <Button className='submit' variant="contained" color="primary">Submit</Button> */}
         <button className='submit' onClick={()=>submitHandler()}>Submit</button>
         <div>
         <textarea className='curriculum-content' value={courseContent} rows="40" columns="240"/>
         </div>
         </div>
         <br/>
